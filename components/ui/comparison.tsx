...
export const ComparisonHandle = ({
  ...
  return (
    ...
    >
      {children ?? (
        <>
          <div className="-translate-x-1/2 absolute left-1/2 h-full w-1 bg-primary" />
          {mode === "drag" && (
            <div className="z-50 flex items-center justify-center rounded-sm bg-primary px-0.5 py-1">
              <GripVerticalIcon className="h-4 w-4 select-none text-white" />
            </div>
          )}
        </>
      )}

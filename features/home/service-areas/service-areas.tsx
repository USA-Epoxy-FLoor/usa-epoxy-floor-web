  ...
  return (
    <section id="service-area" className={cn("w-full py-8")}>
      <ContainerLayout
        ...
        intro="USA Epoxy Floors proudly serves customers throughout the Northeast region."
      >
        <div className="flex mt-8 flex-wrap justify-center max-w-5xl mx-auto gap-6">
